...
public class ManejoArchivos {
    ...
    public ManejoArchivos() throws FileNotFoundException, IOException {
        this.raf = new RandomAccessFile("porfe.txt", "rw"); //Maneja el archivo profesor.txt
        this.raf.seek(0);
        for (int i = 0; i < 200; i = i+2) {
            this.raf.writeChar('\u0000');
        }
        this.rafTree = new RandomAccessFile("porfe.txt", "rw");//Maneja el árbol en el archivo profesor.txt
