...
public class ServletEstudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            bd.agregarEstudiante(name, surname, promedio, sexo);
            ...
            for (int i = 0; i < bd.getNombresEstudiantes().size(); i++) {
                out.println("<h1>Se ha agregado a " + bd.getNombresEstudiantes().get(i) +" "+ bd.getApellidosEstudiantes().get(i) + " con promedio "+bd.getPromedioEstudiantes().get(i)+" y sexo "+bd.getSexoEstudiantes().get(i)+"</h1>");
            }
